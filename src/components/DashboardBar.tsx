...
const DashboardBar: React.FC = () => {
  ...
  return (
    <header className="fixed left-0 z-50 w-full border-b border-slate-200/50 dark:border-slate-800 bg-white/80 dark:bg-[#111111]/80 backdrop-blur-xl shadow-sm">
              ...
              <Link href="/documents" className="cursor-pointer">
                <Button
                  ...
                  className={`
                      ...
                      border-2 border-orange-500 bg-transparent text-orange-500  hover:shadow-xl hover:scale-105 hover:bg-orange-50 dark:hover:bg-orange-500/10
                  `}
                >
